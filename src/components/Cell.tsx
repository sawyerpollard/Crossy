    ...
    return (
        ...
        >
            ...
            {!props.block && <input
                ...
                maxLength={1}
                value={props.value}
                className="w-full h-full text-center text-sm sm:text-2xl selection:bg-transparent touch-manipulation cursor-default outline-none caret-transparent bg-transparent"
            />}
        </div>
    );
}
